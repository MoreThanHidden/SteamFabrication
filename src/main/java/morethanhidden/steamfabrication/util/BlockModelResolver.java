package morethanhidden.steamfabrication.util;

import morethanhidden.steamfabrication.SteamFabrication;
import morethanhidden.steamfabrication.api.IModelRegister;
...
public class BlockModelResolver {
    ...
    public void onModelBake(ModelBakeEvent event) {
        ...
        for (ResourceLocation identifier : Item.REGISTRY.getKeys()) {
            if (!identifier.getResourceDomain().equals(SteamFabrication.MODID)) {
                continue;
            }
